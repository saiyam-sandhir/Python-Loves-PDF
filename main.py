...
main_body_Pdf2Img_button = Button(main_body_LabelFrame_pdfNimg, image = pdf2img_image)
...
main_body_Img2Pdf_button = Button(main_body_LabelFrame_pdfNimg, image = img2pdf_image)
